...
setwd("C:/Users/torsths/Documents/000_changed_documents/Analyses/AnnelidaMitochondrialGenomes/04_Macroevolution/01_CorrelationAnalyses/SequenceProperties")
