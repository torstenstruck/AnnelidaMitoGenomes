...
GeneOrder_aligned_with_tRNA <- read.delim("GeneOrder_aligned_with_tRNA.txt", row.names=1)
...
GeneOrder_aligned_without_tRNA <- read.delim("GeneOrder_aligned_without_tRNA.txt", row.names=1)
